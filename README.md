...
This project includes two implementations of Blowfish algorithm. Its goal was to choose a block cipher using Feistel network and show how to different implementations of the algorithm can differ.<br />
**Design and anlysis of my own algorithm**<br /><br />
